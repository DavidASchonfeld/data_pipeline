...
No. I evaluated this and it's over-engineering for this project:
- MariaDB is a relational database, not a cache store
- I'd need a separate sync job (Airflow DAG or cron) to refresh its data
- I'd need to handle schema drift between Snowflake and MariaDB
