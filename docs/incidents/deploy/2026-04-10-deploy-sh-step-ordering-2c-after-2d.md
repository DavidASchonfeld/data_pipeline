...
Then, immediately after, Step 2c appeared — showing that manifests and secrets hadn't been synced yet when Helm ran. I grepped for step headers in the script and confirmed the ordering: `Step 2d` (line 312) came before `Step 2c` (line 349) and `Step 2c1` (line 355).
