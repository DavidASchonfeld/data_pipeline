# Early Bugs: Configuration and Infrastructure

Historical record of bugs encountered during initial project setup.

---

### Bug 1: The Invisible DAG (Configuration Drift)

**What happened:** The Stock DAG would appear in the Airflow UI for about 30 seconds, then vanish. It kept doing this in a loop — appear, disappear, appear, disappear.
...
**The permanent prevention:** `deploy.sh` now automatically restarts both the Scheduler and Processor pods after every deploy.
