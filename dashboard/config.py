...
SNOWFLAKE_PASSWORD  = os.environ.get("SNOWFLAKE_PASSWORD")           # legacy password — kept as a fallback while the RSA key-pair migration finishes
SNOWFLAKE_PRIVATE_KEY_PATH = os.environ.get("SNOWFLAKE_PRIVATE_KEY_PATH")  # path to the mounted .p8 private key file — used for RSA key-pair auth
